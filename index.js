...
async function logger(embed, userID, extra, file = null) {
    ...
    embed.setTimestamp();
    embed.setFooter({ text: 'Logger • v0.0.5-Alpha by Bedlam Group', iconURL: 'https://yt3.googleusercontent.com/tDyrkpVDd08Bc67PaUwci855_yiIHv6arCEie-mVdYieBQRkj2_mIhMdiGrSZ6D3PBZfoHso=s176-c-k-c0x00ffffff-no-rj' });
