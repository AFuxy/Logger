...
async function logger(embed, userID, extra, file) {
    ...
    embed.setTimestamp();
    embed.setFooter({ text: 'Inspire Tracker • v0.1-Alpha by Bedlam Group', iconURL: 'https://yt3.googleusercontent.com/tDyrkpVDd08Bc67PaUwci855_yiIHv6arCEie-mVdYieBQRkj2_mIhMdiGrSZ6D3PBZfoHso=s176-c-k-c0x00ffffff-no-rj' });
